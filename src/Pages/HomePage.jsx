...
const HomePage = () =>{
    return(
        <div  class="color">
           <div class="conatin">
                <nav class="navbar">
                   <h3 class="main">Vivekanand College</h3>   
                <Header/>
                    </nav>
                <div class="back">
                        {/* <div class="home">
                    <h6>Welcome Vivekanand college</h6>
                    <h3>Your journey to excellence starts here.</h3>
                        <a class="root" href="/admissionpage"><button>Apply now!</button></a>
                    </div> */}
                    <div className="hero-banner">
                    <img src="/Images/background.png" alt="College Banner" />
                    <h1>Welcome to Vivekanand College!</h1>
                    <h3>Your journey to excellence starts here.</h3>
                    <a className="root" href="/admissionpage">
                    ...
                    <p>**Vivekanand College is a premier educational institution dedicated to fostering academic excellence, innovation, and holistic development. Established in [Year of Establishment, e.g., 1980], we have proudly served generations of students, empowering them to achieve their full potential.<br></br><br></br>
                        ...
                        <h3>Ready to explore our courses?</h3>
                            <a class="root" href="/coursespage"><button>Explore Courses </button></a><br></br> <br></br>
                    <nav class="nav">
                         <Footer/>
                    </nav>
            </div>       
